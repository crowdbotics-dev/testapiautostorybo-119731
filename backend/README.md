...
## Project Structure
    ...
    ├── testapiautostorybo_119731  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_119731`
...
2. Clone this repo and `cd testapiautostorybo_119731`
